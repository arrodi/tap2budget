...
const styles = StyleSheet.create({
  ...
  amountIncome: { color: '#145c33' },
  amountExpense: { color: '#145c33' },
  ...
  saveBtn: { marginTop: 'auto', width: '100%', borderWidth: 1, borderColor: '#119647', borderRadius: 18, paddingVertical: 16, alignItems: 'center', backgroundColor: '#16c15a' },
  saveBtnIncome: { backgroundColor: '#16c15a' },
  saveBtnExpense: { backgroundColor: '#16c15a' },
  saveBtnDone: { backgroundColor: '#0f8d45' },

...
const styles = StyleSheet.create({
  ...
  reviewBottomDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: '#D4E97A' },
  reviewBottomDotActive: { backgroundColor: '#166B2A', width: 22 },
  reviewBottomLabel: { color: '#2f7a43', fontSize: 12 },
  reviewBottomLabelActive: { color: '#166B2A', fontWeight: '800' },
